...
return [
    ...
    */
    ...
    'title' =>  'CRM - IMÓVEIS',
    'title_prefix' => '',
    'title_postfix' => '| Sistema de gestão de imobiliárias',
        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    'text' => 'Geral',
                    'url'   => '/geral',
                    'active'=> ['geral','geral','regex:@^geral/[0-9]+$@'],
                ],
                [
                    'accesslevel' => 5,
                    'icon'    => 'fas fa-arrow-circle-right',
                ...
                [
                    ...
                    'text' => 'Corretores',
                    'url'   => '/corretores',
                    'active'=> ['corretores','corretores','regex:@^corretores/[0-9]+$@'],
                ],
                [
                    'accesslevel' => 5,
                    'icon'    => 'fas fa-arrow-circle-right',
                    'text' => 'Proprietários',
                    'url'   => '/proprietarios',
                    'active'=> ['proprietarios','proprietarios','regex:@^proprietarios/[0-9]+$@'],
                ],
                [
                    'accesslevel' => 5,
                    'icon'    => 'fas fa-arrow-circle-right',
                    'text' => 'Locatários',
                    'url'   => '/locatarios',
                    'active'=> ['locatarios','locatarios','regex:@^locatarios/[0-9]+$@'],
                ],
            ]
            ],
        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    'text' => 'Finalidade',
                    'url'   => '/finalidade',
                    'active'=> ['finalidade','finalidade','regex:@^finalidade/[0-9]+$@'],
                ],
                [
                    'accesslevel' => 5,
                    'icon'    => 'fas fa-arrow-circle-right',
                    'text' => 'Tipo do imóvel',
                    'url'   => '/tipo-do-imovel',
                    'active'=> ['tipo-do-imovel','tipo-do-imovel','regex:@^tipo-do-imovel/[0-9]+$@'],
                ],
                [
                    'accesslevel' => 5,
                    'icon'    => 'fas fa-arrow-circle-right',
                    ...
                    'url'   => '/secoes',
                    'active'=> ['secoes','secoes','regex:@^secoes/[0-9]+$@'],
                ],
                [
                    'accesslevel' => 5,
                    'icon'    => 'fas fa-arrow-circle-right',
                    'text' => 'Características extras',
                    'url'   => '/subsecoes',
                    'active'=> ['subsecoes','subsecoes','regex:@^subsecoes/[0-9]+$@'],
                ],
            ]
        ],
        [
        ...
        'App_cadastros' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'admin/js/app_cadastros.min.js',
                ],
            ],
        ],
