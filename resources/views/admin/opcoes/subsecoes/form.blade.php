            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2">
                        ...
                        <input class="form-control" data-name="Sigla " placeholder="Sigla " value="{{ old('nick', $data->nick ?? '') }}" name="nick" required="">
                    </div>

                    <div class="col-lg-3 col-md-2 col-sm-2">
                        <label for="secao_id">*Seção</label>
                        <select name="secao_id" data-name="Setor " class="form-control" required="">
