            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        ...
                        <select name="setor_id" data-name="Setor " class="form-control" required="">
                            <option value="">Selecione...</option>
                            @foreach ($setores as $setor)
                                @if(isset($data))
                                    <option value="{{$setor->id}}" {{($setor->id == $data->setor_id ? 'selected=""' : '')}}>
                                        {{$setor->name}}
                                    </option>
                                @else
                ...
                <div class="row">
                    <div class="col">
                        <label for="nome">DOM (ideal 100 x 90 pixels) </label>
                                            ...
                                            <div class="image barra complete">
                                                ...
                                                <div class="text">
                                                    <div>
                                                        ...
                                                        <a style="cursor:pointer;color: #fff;" data-path="{{url('storage/images/orgmils/'.$data->id.'/')}}" data-image="{{$data->image}}" class="btn btn-info py-0 text-white showImage">Visualizar <i class="fas fa-image" ></i></a>
